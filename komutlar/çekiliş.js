      ...
      message.channel.awaitMessages(filter, {
        ...
        msg.edit(':eight_pointed_black_star:| **Çekilişin süresini belirle (1s, 1m, 1h, 1d, 1w)**').then(msg => {
          message.channel.awaitMessages(filter, {
            ...
            collected.first().delete();
            msg.edit(':eight_pointed_black_star:| **Çekiliş Açıklaması**').then(msg => {
              message.channel.awaitMessages(filter, {
                max: 1,
                time: 20000,
                errors: ['time']
                ...
                try {
                  ...
                  .setFooter(message.author.username + " (Leasess çekiliş sistemi)", message.author.avatarURL);
            ...
            .setFooter("(Kobs çekiliş sistemi)")
                     ...
                     m.edit('** 🎉 ÇEKİLİŞ BİTTİ 🎉**' , {embed: endEmbed});
                       ...
                       var embedLel = new Discord.RichEmbed()
                        .setColor("#f558c9")
                        .setDescription("Ödülünü Moderatörleri Etiketleyerek Alabilirsin!").setFooter("(ZekiBot Çekiliş)")
